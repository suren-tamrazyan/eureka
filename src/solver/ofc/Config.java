...
public class Config {
	...
	public static int NUMBER_OF_ITERATIONS = 15000;
	public static int RANDOM_DEAL_COUNT = 15000; // == NUMBER_OF_ITERATIONS
	public static double EXPLORATION_PARAMETER = 7;//20;//2;//1.41;
	...
	public static long TIME_LIMIT_MS = 18000;
}
