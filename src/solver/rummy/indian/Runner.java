...
public class Runner {
    public static Action run(Collection<Card> heroHand, Collection<Card> knownDiscardedCards, int round, Card wildcard, Card topDiscardPile, DecisionPhase phase, int deckCount, int timeDurationMs) {
